...
var peer = fabric_client.newPeer(creds.peers['173.193.79.114:30324'].url, { pem: creds.peers['173.193.79.114:30324'].tlsCACerts.pem, 'ssl-target-name-override': null });
channel.addPeer(peer);
var order = fabric_client.newOrderer(creds.orderers['173.193.79.114:32018'].url, { pem: creds.orderers['173.193.79.114:32018'].tlsCACerts.pem, 'ssl-target-name-override': null });
channel.addOrderer(order);

var member_user = null;
var store_path = path.join(__dirname, 'wallet', 'app-admin');
...
exports.getBlockchain = async function(req, res, next) {
  try {
    ...
    user_from_store = await fabric_client.getUserContext('app-admin', true);
